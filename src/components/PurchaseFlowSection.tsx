      ...
      <div className="mx-auto grid max-w-[1600px] items-start gap-8 lg:grid-cols-4 lg:items-stretch">
        <div className="flex h-full flex-col lg:col-span-2">
          <div className="text-center">
            ...
            <h2 id="comprar-titulo" className="mt-2 text-3xl font-black text-white">Elegí el método - Valor de Preventa 1 (Incluye una Consumición)</h2>
          </div>
            ...
            <section aria-labelledby="pago-virtual-titulo" aria-live="polite" className="mx-auto max-w-xl">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-3 text-xl font-black text-sky-200">(Incluye una consumición)</p>
