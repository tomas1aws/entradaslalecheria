...
export function PurchaseFlowSection() {
  ...
  return (
    <section id="comprar" className="px-5 py-10 sm:px-8 lg:px-12" aria-labelledby="comprar-titulo">
      <div className="mx-auto grid max-w-[1600px] items-start gap-8 lg:grid-cols-[1.1fr_0.95fr_0.8fr] lg:items-stretch">
        <div className="flex h-full flex-col">
          ...
          <article aria-live="polite" className="mx-auto mt-7 flex w-full max-w-xl flex-1 flex-col rounded-3xl border border-white/10 bg-white/[0.07] p-5 text-center shadow-xl shadow-sky-950/20 sm:p-7 lg:max-w-none">
            ...
            <div className="mt-auto pt-6">
              {isPending ? (
                ...
                <a
                  ...
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-2xl bg-sky-400 px-5 py-3 text-center font-bold text-sky-950 transition hover:bg-sky-200 focus:outline-none focus:ring-4 focus:ring-sky-200/70 sm:w-auto"
                >
