  ...
  return (
    <section id="enviar-comprobante" className="px-5 py-12 sm:px-8 lg:px-12" aria-labelledby="contacto-titulo">
      <div className="mx-auto max-w-6xl rounded-3xl border border-sky-200/20 bg-sky-950/70 p-6 sm:p-8">
        ...
        <p className="mt-3 max-w-3xl text-slate-200">Después de pagar, enviá el comprobante con los datos solicitados para que el organizador pueda verificar tu compra, incluirte en la lista y que posteriormente se te entregue la entrada fisica.</p>
